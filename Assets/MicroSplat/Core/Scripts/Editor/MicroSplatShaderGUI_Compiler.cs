...
public partial class MicroSplatShaderGUI : ShaderGUI
{
   ...
   public static Material NewShaderAndMaterial (string path, string name, string[] keywords = null)
   {
      ...
      {
         string diggerShader = compiler.Compile (keywords, name, null, true);
   ...
   public class MicroSplatCompiler
   {
      ...
      public static bool HasDebugFeature (string[] features)
      {
         ...
         features.Contains ("_DEBUG_OUTPUT_SPECULAR") ||
         features.Contains ("_DEBUG_OUTPUT_MICROSHADOWS") ||
         features.Contains("_DEBUG_BRANCHCOUNT_WEIGHT") ||
         features.Contains ("_DEBUG_BRANCHCOUNT_TRIPLANAR") ||
         features.Contains ("_DEBUG_BRANCHCOUNT_CLUSTER") ||
         features.Contains ("_DEBUG_BRANCHCOUNT_OTHER") ||
         features.Contains ("_DEBUG_BRANCHCOUNT_TOTAL")
