...
public class MicroSplatPropData : ScriptableObject 
{
   ...
   public enum PerTexVector2
   {
      SplatUVScale = 0,
      SplatUVOffset = 2,
      AdvancedDetailsUVScale = 11 * 4,
      AdvancedDetailsUVOffset = 11 * 4 + 2,
   }
   ...
   public enum PerTexFloat
   {
      ...
      AdvancedDetailNormalBlend = 12*4+1,
      AdvancedDetailTexOverlay = 12*4+2,
      AdvancedDetailMeshOverlayBlend = 12*4+3,
      AdvancedDetailContrast = 13*4,
      AdvancedDetailAngleContrast = 13+4+1,
      AdvancedDetailHeightContrast = 13+4+2,
      AdvancedDetailDistanceResampleUVScale = 13+4+3,
